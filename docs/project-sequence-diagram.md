...
- Use diagram 1 in your project report or README as the system-wide sequence diagram.
- Use diagram 2 when explaining the donor profile module specifically.
- If you want, I can also draw separate sequence diagrams for blood request workflow, hospital application approval, or admin donor management.
